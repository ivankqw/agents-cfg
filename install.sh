...
# Repo-owned and private skills join the shared skill directory. Both harnesses
# discover the same names there. Installer-managed third-party directories stay in place.
