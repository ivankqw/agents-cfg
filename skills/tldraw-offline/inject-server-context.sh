...
server_json='/mnt/c/Users/IvanKoh/AppData/Roaming/tldraw/server.json'
...
if [ -x /mnt/c/Windows/System32/curl.exe ]; then
  docs=$(/mnt/c/Windows/System32/curl.exe -s --max-time 2 -X POST "http://localhost:$port/api/search" \
